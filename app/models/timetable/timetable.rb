...
#     def initialize(has_lessons, date_in_week = Date.current)
#       fail 'first param must have a "lessons" association' unless has_lessons.respond_to? :lessons
#       fail 'first param must be a Date' unless date_in_week.is_a? Date
